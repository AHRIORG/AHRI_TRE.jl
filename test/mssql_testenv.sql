DROP TABLE IF EXISTS dbo.causes;
DROP TABLE IF EXISTS dbo.[cause_categories];
...
CREATE TABLE [cause_categories] (
  [cause_category] int NOT NULL,
  [label] nvarchar(255) NOT NULL,
  CONSTRAINT [PK_cause_categories] PRIMARY KEY ([cause_category])
);
